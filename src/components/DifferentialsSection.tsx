      ...
      <AnimatedSection>
        <div className="rounded-2xl border border-border/50 overflow-hidden backdrop-blur-xl bg-card/40">
          ...
          <div className="grid grid-cols-3 border-b border-border/40">
            ...
            <div className="p-3 sm:p-5 text-center border-x border-border/30">
            ...
            <div className="p-3 sm:p-5 text-center relative overflow-hidden">
          ...
          {rows.map((r, i) => (
            <div
              key={i}
              className={`grid grid-cols-3 transition-colors hover:bg-muted/20 ${
                i < rows.length - 1 ? "border-b border-border/30" : ""
              }`}
            >
              <div className="p-3 sm:p-5 flex flex-col items-start justify-center gap-1 sm:flex-row sm:items-center sm:gap-3">
                <span className="text-muted-foreground shrink-0">{r.icon}</span>
                <span className="text-[11px] sm:text-sm font-semibold text-foreground leading-tight">{r.label}</span>
              </div>
              <div className="p-3 sm:p-5 flex flex-col items-center justify-center gap-1.5 sm:flex-row sm:gap-2 border-x border-border/30 text-center">
              ...
              <div className="p-3 sm:p-5 flex flex-col items-center justify-center gap-1.5 sm:flex-row sm:gap-2 relative text-center">
                <div className="absolute inset-0 bg-primary/[0.04]" />
                <Check className="h-4 w-4 shrink-0 text-primary relative z-10" />
